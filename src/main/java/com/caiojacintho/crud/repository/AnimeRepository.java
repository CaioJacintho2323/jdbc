...
public class AnimeRepository {
    ...
    public static List<Anime> findbyName(String name) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while to find all Anime", e);
        }
        return animes;
    }
    ...
    public static void delete(int id) {
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while to delete Anime '{}'", id, e);
        }
    }
    ...
    public static void save(Anime Anime) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
             PreparedStatement ps = createPrepareStatement(conn, Anime);) {
            ps.execute();
        } catch (SQLException e) {
            log.error("Error while to update Anime '{}'", Anime.getId(), e);
        }
    }
    private static PreparedStatement createPrepareStatement(Connection conn, Anime anime) throws SQLException {
